...
public class InfoWindowView implements Serializable {
    ...
    public void init() {
        ...
        for (SaleOpportunity saleOpportunity : saleOpportunityService.findAll()) {
            LatLng coord = new LatLng(saleOpportunity.getLat(), saleOpportunity.getLng());
            Marker m = new Marker(coord, "Konyaalti") ;
