...
public class MenuController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        listMenu.getItems().addAll(" CRM", "  Finance", "  Supply Chain", "  Marketing", "  Project Management", "  HR",
                "  Maintenance","  Test");
        Platform.runLater(() -> {
    ...
    void aksiKlikListMenu() {
        ...
        case 0:{
            con.loadAnchorPane(paneData, "7aja.fxml");
        }break;
        case 1:{
            con.loadAnchorPane(paneData, "Purchase.fxml");
        }break;
        case 2:{
            con.loadAnchorPane(paneData, "item.fxml");
        }break;
        case 7:{
            con.loadAnchorPane(paneData, "test1.fxml");
        }break;
        }
    }
    ...
    void aksiLogout() {
        ...
        config.newStage((Stage) btnLogout.getScene().getWindow(), "/fxml/login.fxml", "Sample Apps", true, StageStyle.UNDECORATED, false);
