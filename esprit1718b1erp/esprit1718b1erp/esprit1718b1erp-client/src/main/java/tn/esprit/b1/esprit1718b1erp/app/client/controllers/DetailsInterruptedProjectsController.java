...
public class DetailsInterruptedProjectsController implements Initializable{
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        Created.setText(String.valueOf(project.getCreationDate()));
        Delivered.setText(String.valueOf(project.getInterruptionDate()));
        Description.setText(project.getReason());
...
pieChartTasksShow();
    ...
    private void pieChartTasksShow() {
        ObservableList<PieChart.Data> pieChartData = FXCollections.observableArrayList();
        for (Task i : project.getTasks()) {
            if (i != null) {
                pieChartData.add(new PieChart.Data(i.getNomTache(), i.getPriorite()));
            }

        }
        PieChartTasks.setData(pieChartData);
    }
}
